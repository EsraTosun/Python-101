...
result = ' Hello World '.lstrip()   # sol tarafı siler
result = ' Hello World '.rstrip()   # sağ tarafı siler
...
result = course.rfind('Python')    # saymaya sapdan başlar
...
result = course.replace(' ', '-',5)   #5 kadarkter değiştirir
result = course.replace(' ', '')
