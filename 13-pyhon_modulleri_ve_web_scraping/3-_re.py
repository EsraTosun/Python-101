import re
# Arama sonucunda bize sonuç döndürür.
# Arama kriterlerini bu import ile geliştirebiliriz
...
# re.findall()
# aradığımz ifadenin liste içerisinde bulunup bulunmadığını bize döndürür.

# result = re.findall("Python",str)
# result = len(result)

# re.split()
# istediğimiz karaktere göre her ifadeyi bölmemizi sağlar

# result = re.split(" ", str)
# result = re.split("R", str)

# re.sub()
# ,stediğimiz bir karakteri başka bir karakter ile değiştirmemizi sağlar

# result = re.sub(" ","-",str)
# result = re.sub("\s","-",str)

# re.search()
# istediğimiz ifadeyi hangi karalterden başladığını ve bittiğini bize bildirir.

# result = re.search("Python",str)

# result = result.span()    # konumunu
# result = result.start()   # başlangıç index
# result = result.end()     # bitiş index
# result = result.group()   # bulduğu ifadeyi gösterir
# result = result.string    # aradığı ifadeyi gösterir
